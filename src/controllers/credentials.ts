...
export class CredentialController {
  public static issueValidator = [
    check("subjectDid")
      .exists()
      .withMessage("subjectDid is required")
      .isString()
      .withMessage("subjectDid should be a string")
      .contains("did:")
      .withMessage("subjectDid should be a DID"),
    check("attributes")
      .exists()
    ...
    check("type")
      .optional()
      .isArray()
      .withMessage("type should be a string array"),
    check("@context")
      .optional()
      .isArray()
      .withMessage("@context should be a string array"),
  ...
  public async verify(request: Request, response: Response) {
    ...
    try {
      return response.json(
        await Credentials.instance.verify_credentials(request.body.credential)
      );
    } catch (error) {
      response.status(500).json({
        error: `Internal error: ${error}`,
